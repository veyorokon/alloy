...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Alloycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"alloycointools.com", "207.154.228.12"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"alloycointools.com", "testnet-seed.alloycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Alloycoin is probably already running."), addrBind.ToString().c_str());
        else
